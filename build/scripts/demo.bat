...
set CLASSPATH=%APP_HOME%\lib\demo-0.0.1-SNAPSHOT.jar;%APP_HOME%\lib\groovy-3.0.9.jar


@rem Execute demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEMO_OPTS%  -classpath "%CLASSPATH%" com.multivaluedictionary.Program %*
